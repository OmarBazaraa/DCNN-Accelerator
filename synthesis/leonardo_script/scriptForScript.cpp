...
int main() {
	...
	while(cin>>filePath>>fileName>>archName) {
		...
		cout << "read -technology \"tsmc035_typ\"  -dont_elaborate { " + filePath + "/" + fileName + ".vhd }\n";
		
		//cout << "pre_optimize -common_logic -unused_logic -boundary -xor_comparator_optimize \n";
		//cout << "pre_optimize -extract \n";
		cout << "elaborate " + fileName + " -architecture " + archName + " \n";
		cout << "pre_optimize .work." + fileName + "." + archName + " -xor_comparator_optimize \n";
		cout << "pre_optimize .work." + fileName + "." + archName + " \n";
		...
		// if (fileName == "main") {
			...
			cout << "report_area /home/ayman/Desktop/repo/DCNN-Accelerator/synthesis/generated_files/report_area_"+fileName+".txt -cell_usage -all_leafs \n";
		// }
		...
		// if (fileName == "main") {
			cout << "report_delay /home/ayman/Desktop/repo/DCNN-Accelerator/synthesis/generated_files/report_delay_"+fileName+".txt -num_paths 1 -critical_paths -clock_frequency\n";
		// }
